...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=False if 'localhost' in os.environ.get('DATABASE_URL', '') or '127.0.0.1' in os.environ.get('DATABASE_URL', '') or not os.environ.get('DATABASE_URL') else True
    )
}
